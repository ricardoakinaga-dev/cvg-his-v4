...
- Artefatos brutos: artifacts.json (histórico arquivado: `legado/docs/vetus/inspection/2026-04-23T22-00-01-706Z/artifacts.json`)
- Shell autenticado: 03-shell-expanded.png (histórico arquivado: `legado/docs/vetus/inspection/2026-04-23T22-00-01-706Z/screenshots/03-shell-expanded.png`)
- Home: -inicio.png (histórico arquivado: `legado/docs/vetus/inspection/2026-04-23T22-00-01-706Z/screenshots/-inicio.png`)
- Comandas: -comandas.png (histórico arquivado: `legado/docs/vetus/inspection/2026-04-23T22-00-01-706Z/screenshots/-comandas.png`)
- Dashboard financeiro: -dashboard-financeiro.png (histórico arquivado: `legado/docs/vetus/inspection/2026-04-23T22-00-01-706Z/screenshots/-dashboard-financeiro.png`)
