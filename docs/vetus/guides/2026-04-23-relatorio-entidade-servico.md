...
- servicos-lista.png (histórico arquivado: `legado/docs/vetus/inspection/2026-04-23T23-16-39-933Z-servicos/screenshots/servicos-lista.png`)
- servicos-lista.json (histórico arquivado: `legado/docs/vetus/inspection/2026-04-23T23-16-39-933Z-servicos/servicos-lista.json`)
- servicos-lista.html (histórico arquivado: `legado/docs/vetus/inspection/2026-04-23T23-16-39-933Z-servicos/servicos-lista.html`)
- estado-pos-login.json (histórico arquivado: `legado/docs/vetus/inspection/2026-04-23T23-16-39-933Z-servicos/estado-pos-login.json`)
- estado-servicos.json (histórico arquivado: `legado/docs/vetus/inspection/2026-04-23T23-16-39-933Z-servicos/estado-servicos.json`)
- network-lite.json (histórico arquivado: `legado/docs/vetus/inspection/2026-04-23T23-16-39-933Z-servicos/network-lite.json`)
...
Isso está confirmado no recorte de rede em network-lite.json (histórico arquivado: `legado/docs/vetus/inspection/2026-04-23T23-16-39-933Z-servicos/network-lite.json`).
