...
- o artefato [estado-pos-login.json](../../inspection/2026-04-24T00-30-01-103Z-esteira-exames/estado-pos-login.json) registra a página `Um momento...` com `Executando verificação de segurança`;
