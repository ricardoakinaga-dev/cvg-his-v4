...
| --- | --- | --- | --- | --- |
| AUD21-01 | Reconciliar identity, registro P0 e snapshots em um único SHA | PASS-LOCAL | AUD21-02–04, AUD21-09–10 | identity/P0/snapshots vinculados à identidade `6a6aeaf5` sobre fonte/runtime `51982f48`; estados `NOT_PROVEN` preservados |
...
| NR-004 | Recriar identidade e snapshots do candidato sem promover prova stale | PASS-LOCAL | AUD21-01–04, AUD21-09–10, NR-001–003, NR-006 | guardas recusam worktree sujo; identity/registry/snapshots convergem na identidade `6a6aeaf5` sobre fonte/runtime `51982f48` |
...
| NR-006 | Congelar novo SHA e executar regressão local integrada | PASS-LOCAL | AUD21-02–04, AUD21-09–10, NR-001–003 | gates locais passam na fonte/runtime `51982f48`; identidade `6a6aeaf5`; Helm obrigatório disponível; críticos 11/11 e E2E 424/424 |
| NR-007 | Reconstruir API/worker/SPA e provar runtime production-shaped | PASS-LOCAL | NR-004, NR-006 | três OCI locais distintas, non-root/read-only, Vault e dependências descartáveis, proxy e readiness passam na fonte/runtime `51982f48`; identidade `6a6aeaf5`; sem publicação |
