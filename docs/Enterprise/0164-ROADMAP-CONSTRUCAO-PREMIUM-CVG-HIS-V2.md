...
**Objetivo:** orientar a construcao do CVG-HIS V2 com as diretrizes premium do Vetus-like, mantendo `apps/spa` como frontend oficial alvo e `apps/web` apenas como legado de transicao.
...
| Principio | Diretriz |
|---|---|
| Uma trilha oficial | nada de novo em `apps/web` exceto compatibilidade e transicao |
...
| `apps/web` e legado de transicao | apenas compatibilidade enquanto a migracao por dominio nao termina |
...
2. `apps/web` desativado da trilha operacional
