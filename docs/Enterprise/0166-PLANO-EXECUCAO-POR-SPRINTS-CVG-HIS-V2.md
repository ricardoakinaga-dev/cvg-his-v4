...
- `apps/web` apenas como legado de transicao
...
Fechar a camada comercial e executar o corte do `apps/web`.
...
- F08-01 cortar novas entregas em `apps/web`
...
- `apps/web` deve estar fora da trilha principal
