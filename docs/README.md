...
**Atualizado em:** 2026-09-21 (identidade do candidato `43f66b92`; fonte/runtime `51982f48`)
...
1. [Auditoria e scorecard da identidade `43f66b92` (fonte/runtime `51982f48`)](2026-09-20-auditoria-scorecard-db07cd02.md) — notas 0–100, veredito, provas e blockers.
...
8. [Snapshot Triple-A corrente](triple-a/15-current-baseline.md) e [evidência associada](triple-a/17-current-execution-evidence.md) — identidade `43f66b92` sobre a fonte/runtime `51982f48`; CI/target/UAT continuam `NOT_PROVEN`.
...
10. [Relatório final de assurance](triple-a/FINAL_REPORT.md), [scorecard](triple-a/13-final-scorecard.md) e [execution log](triple-a/EXECUTION_LOG.md) — identidade corrente `43f66b92`, fonte/runtime `51982f48`, com limitações externas explícitas.
