...
**Atualizado em:** 2026-09-21 (identidade do candidato `8b85e3a9`; fonte/runtime `29b03941`)
...
1. [Auditoria e scorecard da identidade `8b85e3a9` (fonte/runtime `29b03941`)](2026-09-20-auditoria-scorecard-db07cd02.md) — notas 0–100, veredito, provas e blockers.
...
8. [Snapshot Triple-A corrente](triple-a/15-current-baseline.md) e [evidência associada](triple-a/17-current-execution-evidence.md) — identidade `8b85e3a9` sobre o runtime `29b03941`; CI/target/UAT continuam `NOT_PROVEN`.
...
10. [Relatório final de assurance](triple-a/FINAL_REPORT.md), [scorecard](triple-a/13-final-scorecard.md) e [execution log](triple-a/EXECUTION_LOG.md) — identidade `8b85e3a9`, runtime `29b03941`, com limitações externas explícitas.
