...
8. [Baseline corrente](triple-a/15-current-baseline.md) e [evidência corrente](triple-a/17-current-execution-evidence.md) — candidato `f24b90a8`, envelope de eventos, crosswalk e pins de supply chain validados, com limitações explícitas.
