...
O MCP Blender criou a cena própria de órbitas em petróleo, mineral e champagne. Foram produzidos [vídeo de três segundos](frontend/assets/video/cvg-pulse-orbit.mp4), [poster](frontend/assets/images/cvg-pulse-orbit.webp) e fonte editável. Na consulta final de 07/09/2026, a geração ComfyUI está **concluída**: [prévia 384×224](frontend/assets/images/0836ac61_000.png) coletada e inspecionada. É estudo de material, ainda sem aprovação de produção ou incorporação ao caderno. O [registro dos assets](frontend/assets/README.md) explica execução, cancelamentos, limitações e retomada.
