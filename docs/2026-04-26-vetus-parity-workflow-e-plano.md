...
- SPA: `http://localhost:3002`
- API: `http://localhost:3003`
- Ultima rota validada: `http://localhost:3002/cofins`
- API health validado em `http://localhost:3003/health`
- Ultima API validada: contrato SPA/API para `GET /fiscal/cofins?search=7,6`
...
| Estoque | Em andamento | Observar no Vetus `Estoque > Configuracoes Fiscais > Tabela CFOP` antes de mexer em codigo. |
