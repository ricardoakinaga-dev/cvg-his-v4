...
- SPA: `http://localhost:3002`
- API: `http://localhost:3003`
- Ultima rota validada: `http://localhost:3002/pis`
- API health validado em `http://localhost:3003/health`
- Ultima API validada: contrato SPA/API para `GET /fiscal/pis?search=0,65`
- Ultima migration aplicada nesta frente: `0039_fiscal_pis_tables` (`0040_animal_species_vetus_system_codes` ja constava aplicada anteriormente no banco)
...
| Estoque | Em andamento | Observar no Vetus `Estoque > Configuracoes Fiscais > Tabela COFINS` antes de mexer em codigo. |
