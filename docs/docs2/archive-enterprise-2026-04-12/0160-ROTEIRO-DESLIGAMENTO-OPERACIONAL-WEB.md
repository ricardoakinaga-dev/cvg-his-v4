...
## Status de execucao 2026-04-12

Checklist consolidado do corte:

- `apps/web` congelado por guardrail executavel em `pnpm guardrail:legacy-web`
- compose oficial manteve `cvg-his-v2-web` somente em `profile legacy`
- proxy oficial segue apontando o dominio principal para a SPA
- matriz por dominio foi encerrada com todos os dominios em `web desligado`
- validacao automatica do alinhamento operacional disponivel em `pnpm cutover:check`
- docs vivas do frontend oficial foram alinhadas para `apps/spa`
...
- estado atual: concluido com freeze operacional e guardrail automatizado
...
- estado atual: concluido; compose e proxy oficial apontam para `apps/spa`
...
- estado atual: concluido; o web ficou isolado em perfil legado
...
No estado atual, o legado ja esta fora do caminho ativo do produto e permanece apenas como referencia historica/rollback controlado.
...
- [0168 - Matriz de Corte Web para SPA por Dominio](/root/.openclaw/workspace/cvg-his-v2/docs/Enterprise/0168-MATRIZ-CORTE-WEB-PARA-SPA-POR-DOMINIO.md)
- [README](/root/.openclaw/workspace/cvg-his-v2/README.md)
