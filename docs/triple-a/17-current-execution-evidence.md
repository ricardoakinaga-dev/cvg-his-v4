...
## Candidato documental observado em 2026-09-17T07:35:26Z

- SHA de código e documentação: `144b3b443e966b81fb600dae9c385fafec8516d0`;
  identidade em
...
| Identidade/evidence graph | Identidade canônica do snapshot documental `144b3b44`; registro P0 `1 CLOSED / 13 OPEN`; graph/CI/authority permanecem `BLOCKED / NOT PROVEN` |
...
| Vue especializado current | A captura visual local do candidato `144b3b44` passou `29/29` contra os snapshots versionados após a fixação de Noto Sans; o CI remoto exato ainda aguarda execução, sem promoção de baseline |
