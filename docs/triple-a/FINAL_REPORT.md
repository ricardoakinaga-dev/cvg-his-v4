...
Este relatório registra o candidato local após as correções de frescor do release gate e acessibilidade clínica. O CI #113 pertence ao pai `533a12a4` e terminou com 16/16 jobs aprovados; nenhum resultado é transferido para `055f282d`. O resultado não autoriza release; as provas externas, operacionais e humanas exigidas continuam ausentes.
...
- O CI [#34599938521](https://github.com/ricardoakinaga-dev/cvg-his-v4/actions/runs/34599938521) pertence ao pai `533a12a4` e terminou `success` com 16/16 jobs, incluindo E2E SPA e Integration. Nenhum resultado é promovido como prova do SHA `055f282d`.
