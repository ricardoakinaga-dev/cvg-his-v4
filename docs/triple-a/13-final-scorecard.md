...
| Campo              | Estado                                                                                                                                                                                                                                                    |
| ------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| CURRENT SNAPSHOT   | candidato de código `f2e2da4cab80917d7c6bea0ddf1e55d58eb6821c` (hardening de logging); snapshot documental anterior `0d475dee358eab9621e5497db9929b7010ed09eb`                                                                                                                                           |
| MAIN / ORIGIN      | `HEAD == main == origin/main`; rollback preservado, sem force-push                                                                                                                                                                                        |
| CURRENT CI         | [#154](https://github.com/ricardoakinaga-dev/cvg-his-v4/actions/runs/34695196945) foi disparado antes da reancoragem e estava em andamento; a nova execução vinculada ao snapshot está pendente. |
...
| Decisão            | Reancorar o snapshot no candidato de código `f2e2da4c`, registrar o hardening de logging e aguardar CI terminal vinculado, mantendo `BLOCKED` sem relaxar SLOs ou provas externas.                    |
