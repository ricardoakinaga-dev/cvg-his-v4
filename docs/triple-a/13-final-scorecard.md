...
| Campo | Estado |
| --- | --- |
| CURRENT SNAPSHOT | `68bea151102c01ee54a3c782b5cf4b1c3ad631f5` (docs-only; code parent `b77539c9891eef89cbbe8160bf6e30a0fb369d48`) |
...
O CI #127 aprovou os contratos, testes unitários e de integração, E2E SPA,
visual, segurança, typecheck, lint, build e o contrato Windows. Performance
terminou com exit 99/1 nos passos do benchmark/SLO. Sem logs autenticados, não
há causa raiz comprovada e nenhuma threshold foi alterada.
