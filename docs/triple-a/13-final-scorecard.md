...
| Campo              | Estado                                                                                                                                                                                                                                                    |
| ------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| CURRENT SNAPSHOT   | candidato de código `f24b90a8a50839b6a8853d66ef8ab4b7754092e0` (pins imutáveis de deployment, envelope de eventos, crosswalk e hardening conjunto de logging/workflow/tenant); snapshot documental anterior `0d475dee358eab9621e5497db9929b7010ed09eb`                                                                                                                                           |
| MAIN / ORIGIN      | `HEAD == main == origin/main`; rollback preservado, sem force-push                                                                                                                                                                                        |
| CURRENT CI         | [CI #155](https://github.com/ricardoakinaga-dev/cvg-his-v4/actions/runs/34695557227) pertence ao commit documental anterior e não é promovido; a nova execução vinculada ao snapshot `f24b90a8` está pendente. |
...
| Decisão            | Reancorar o snapshot no candidato de código `f24b90a8`, registrar os pins imutáveis e aguardar CI terminal vinculado, mantendo `BLOCKED` sem relaxar SLOs ou provas externas.                    |
