...
| Campo              | Estado                                                                                                                                                                                                                                                    |
| ------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| CURRENT SNAPSHOT   | candidato de código `e605597c73a54e7d4c001fad6c5a83806d22d4ba` (pins imutáveis de deployment, envelope de eventos, crosswalk e hardening conjunto de logging/workflow/tenant); snapshot documental anterior `0d475dee358eab9621e5497db9929b7010ed09eb`                                                                                                                                           |
| MAIN / ORIGIN      | `HEAD == main == origin/main`; rollback preservado, sem force-push                                                                                                                                                                                        |
| CURRENT CI         | [CI #155](https://github.com/ricardoakinaga-dev/cvg-his-v4/actions/runs/34695557227) pertence ao commit documental anterior e não é promovido; a nova execução vinculada ao snapshot `e605597c` está pendente. |
