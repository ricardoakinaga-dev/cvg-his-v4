...
| CURRENT CI         | [#147](https://github.com/ricardoakinaga-dev/cvg-his-v4/actions/runs/34684079972) em `main@8273ecb5` terminou `success` com `16/16` jobs verdes, incluindo API E2E clínico canônico isolado; o candidato `a3354f02` foi confirmado remotamente. |
...
| Decisão            | Recalcular o candidato `a3354f02`; registrar CI #147 verde e manter `BLOCKED` porque o gate local e as provas externas de target continuam ausentes.                 |
