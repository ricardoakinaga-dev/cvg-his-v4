...
| CURRENT CI         | [#151](https://github.com/ricardoakinaga-dev/cvg-his-v4/actions/runs/34690210769) em `main@fecb70ca` terminou `failure` somente em `Performance (k6 SLOs)`; `15/16` jobs passaram, incluindo Repository Guards, Integration, E2E SPA e Visual Regression. |
...
| Decisão            | Reconciliar o candidato `553078be`; registrar #151 como falha legítima de Performance/k6, mantendo `BLOCKED` sem relaxar SLOs ou provas externas.                    |
