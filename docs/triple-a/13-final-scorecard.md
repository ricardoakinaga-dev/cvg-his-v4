...
| Campo              | Estado                                                                                                                                                                                                                                                    |
| ------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| CURRENT SNAPSHOT   | candidato `721b2bb3eb140921eabf271d8e59c222106f40a7`; identidade canônica em `CURRENT_CANDIDATE_IDENTITY.json`; registro P0 candidate-bound; Noto Sans e rasterização de texto determinísticos nos gates E2E/visual; orçamento de `server.ts` em `8.335` linhas; teste Node nativo de feature flags preservado na suíte oficial e excluído da varredura global do Vitest; históricos não são transferidos |
| MAIN / ORIGIN      | `main` local contém o candidato `721b2bb3`; a `main` remota está publicada via Git Data API sem force-push; `origin/fix/state-of-art-ci-assurance@fe5406c2` é ancestral sem commits funcionais exclusivos, rollback preservado |
