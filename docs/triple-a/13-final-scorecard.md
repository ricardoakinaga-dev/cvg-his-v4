...
| CURRENT CI         | [#149](https://github.com/ricardoakinaga-dev/cvg-his-v4/actions/runs/34687849607) em `main@553078be` terminou `failure` no `Repository Guards` por snapshots stale; os jobs iniciais, Coverage e OpenAPI passaram. |
...
| Decisão            | Reconciliar o candidato `553078be`; registrar #149 como falha legítima de snapshot stale, mantendo `BLOCKED` sem relaxar SLOs ou provas externas.        |
