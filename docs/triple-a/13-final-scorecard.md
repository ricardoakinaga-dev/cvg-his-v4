...
| Campo              | Estado                                                                                                                                                                                                                                                    |
| ------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| CURRENT SNAPSHOT   | candidato de código `d848843173bca9a94b8c1f2914d3a3654eb4ce84` (pins imutáveis de deployment, envelope de eventos, crosswalk e hardening conjunto de logging/workflow/tenant); snapshot documental anterior `0d475dee358eab9621e5497db9929b7010ed09eb`                                                                                                                                           |
| MAIN / ORIGIN      | `HEAD == main == origin/main`; rollback preservado, sem force-push                                                                                                                                                                                        |
| CURRENT CI         | [CI #155](https://github.com/ricardoakinaga-dev/cvg-his-v4/actions/runs/34695557227) pertence ao commit documental anterior e não é promovido; a nova execução vinculada ao snapshot `d8488431` está pendente. |
...
| Decisão            | Reancorar o snapshot no candidato de código `d8488431`, registrar os pins imutáveis e aguardar CI terminal vinculado, mantendo `BLOCKED` sem relaxar SLOs ou provas externas.                    |
