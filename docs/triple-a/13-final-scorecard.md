...
| Campo              | Estado                                                                                                                                                                                                                                                    |
| ------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| CURRENT SNAPSHOT   | candidato `dfa6d0b4ea60d6e7fbbe42521793b9fad273f702`; identidade canônica em `CURRENT_CANDIDATE_IDENTITY.json`; registro P0 candidate-bound; Noto Sans e rasterização de texto determinísticos nos gates E2E/visual; históricos não são transferidos |
...
| CURRENT CI         | O [CI #214](https://github.com/ricardoakinaga-dev/cvg-his-v4/actions/runs/35204183554) terminou `failure`: todos os gates estruturais, críticos, E2E SPA (`424/424`) e Visual (`29/29`) passaram; k6 passou `7/9` SLOs e reprovou query/inventory |
...
| CURRENT VERDICT    | **BLOCKED / NOT PROVEN**; o CI #214 terminou com falha de performance em query/inventory, e target, recovery, UAT e autoridade externa continuam sem prova |
