...
| CURRENT CI         | [#145](https://github.com/ricardoakinaga-dev/cvg-his-v4/actions/runs/34680830958) no `main@66a605be` terminou `failure` com 15/16 jobs verdes e falha exclusiva em Performance/k6; E2E, integração e `Repository Guards` passaram. O #144 anterior falhou no guard por checkout raso; não há CI verde para `56a18736` |
