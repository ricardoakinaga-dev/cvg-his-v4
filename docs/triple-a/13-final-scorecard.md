...
| CURRENT CI         | [#152](https://github.com/ricardoakinaga-dev/cvg-his-v4/actions/runs/34692643050) em `main@0d475dee` está `in_progress`; nenhum resultado parcial é promovido. |
...
| Decisão            | Reancorar o snapshot no candidato de assurance `0d475dee` e aguardar o CI #152 terminal, mantendo `BLOCKED` sem relaxar SLOs ou provas externas.                    |
