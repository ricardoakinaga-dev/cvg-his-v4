...
| Campo | Estado |
| --- | --- |
| CURRENT CODE CANDIDATE | `b77539c9891eef89cbbe8160bf6e30a0fb369d48` |
| MAIN / ORIGIN | Coincidem no mesmo SHA; atualização anterior foi fast-forward, sem force-push |
...
O CI #126 aprovou os contratos, testes unitários e de integração, E2E SPA,
visual, segurança, typecheck, lint e build. Performance terminou com exit 99/1
nos passos do benchmark/SLO; o contrato Windows terminou com exit 1. Sem logs
autenticados, não há causa raiz comprovada e nenhuma threshold foi alterada.
