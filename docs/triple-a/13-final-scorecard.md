...
| Campo | Estado |
| --- | --- |
| CURRENT CODE CANDIDATE | `59a630875d9ee6e1050ba39195fc0771c4d3501d`; `main`/`origin/main` sincronizados; rollback preservado em `fix/state-of-art-ci-assurance` |
| DOCUMENTATION SNAPSHOT | Frescor do gate, identidade declarada do prompt e correções de acessibilidade clínica implementados; CI exato passou |
| CURRENT SCORE | `34` no gate estrito local de `59a63087`; mínimo 97 |
| CURRENT CRITICAL SCORE | `23` no gate estrito local de `59a63087`; mínimo 95 |
| CURRENT OPEN P0 | `27` no gate estrito local de `59a63087`; o quality bar exige zero |
