...
| Campo              | Estado                                                                                                                                                                                                                                                    |
| ------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| CURRENT SNAPSHOT   | candidato de assurance `0d475dee358eab9621e5497db9929b7010ed09eb`; candidato funcional/workflow anterior `553078be60c963ffb7cab5c45c130912e5e299b8`                                                                                                                                           |
| MAIN / ORIGIN      | `HEAD == main == origin/main`; rollback preservado, sem force-push                                                                                                                                                                                        |
| CURRENT CI         | [#153](https://github.com/ricardoakinaga-dev/cvg-his-v4/actions/runs/34693263252) em `main@9955b8b5` terminou `failure` com `15/16` jobs verdes; somente `Performance (k6 SLOs)` falhou. |
...
| Decisão            | Reancorar o snapshot no candidato de assurance `0d475dee` e registrar o CI #153 como falha exclusiva de Performance/k6, mantendo `BLOCKED` sem relaxar SLOs ou provas externas.                    |
