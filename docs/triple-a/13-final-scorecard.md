...
| CURRENT CI         | O CI #203 do ancestral `261e5b45` falhou no harness E2E/visual e no SLO de performance; a reprodução canônica passou e o novo run exato aguardará a publicação de `b313fba7` |
