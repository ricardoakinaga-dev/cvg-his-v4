...
| Campo              | Estado                                                                                                                                                                                                                                                    |
| ------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| CURRENT SNAPSHOT   | candidato de código `49569934f9c4c25df98cc0d18203b57db1433440` (onda local de remediação OpenAPI/OIDC, supply chain, pacote visual, outbox e controles); resultados remotos/target ainda não comprovados                                                                                                                                           |
