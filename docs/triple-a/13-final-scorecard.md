...
| Campo              | Estado                                                                                                                                                                                                                                                    |
| ------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| CURRENT SNAPSHOT   | candidato `8bb1bd71b34d9ed102aee223a51715df244b8c45`; identidade canônica em `CURRENT_CANDIDATE_IDENTITY.json`; registro P0 candidate-bound; Noto Sans e rasterização de texto determinísticos nos gates E2E/visual; históricos não são transferidos |
| MAIN / ORIGIN      | `main` local contém o candidato `03e6fac0`; a `main` remota foi atualizada via Git Data API sem force-push para o candidato `8bb1bd71`; `origin/fix/state-of-art-ci-assurance@fe5406c2` é ancestral sem commits funcionais exclusivos, rollback preservado |
...
na revisão 69. O registro P0 adiciona deduplicação, dependências, classificação
