...
| Campo | Estado |
| --- | --- |
| CURRENT SNAPSHOT | `5bb94d8f3fa4534fc3cdb12b71b2becdaede7780` — rebind de 26/09/2026 para o candidato da rodada 2; nenhuma evidência de execução foi refeita neste SHA (status BLOCKED / NOT PROVEN). As evidências registradas pertencem a `d9a16cf45898` — mapeamento em `evidence/sha-remap-20260926.json` |
