...
Observado em `2026-09-17T23:39:52Z`, sobre o candidato documental
`db47bb1501b9c713213b0b4d4f1794c2a5b6f53b`, que contém a identidade corrente
...
| --------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| current_sha     | `db47bb1501b9c713213b0b4d4f1794c2a5b6f53b` (snapshot; registro P0 e manifesto revision 78; unificação de ACL, readiness Redis, tracing HTTP seguro contra credenciais em query string, observabilidade do worker, contrato produtivo e catálogo de eventos; importador do evidence graph mantém validação candidate-bound e evidência local sem promoção automática a PASS) |
