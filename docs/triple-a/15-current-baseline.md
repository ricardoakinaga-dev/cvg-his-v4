...
`e4acaf40e399dd29f7c6ec51232dd0ecc92301b7`, que contém a identidade corrente
e a correção funcional de fail-closed, autoridade request-scoped e ownership composto no commit
`e4acaf40e399dd29f7c6ec51232dd0ecc92301b7`, sobre a otimização do
...
| --------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| current_sha     | `8bb1bd71b34d9ed102aee223a51715df244b8c45` (snapshot; registro P0 e manifesto revision 69; Noto Sans e rasterização sem LCD determinísticos nos gates E2E/visual; verificação portátil do runner; endurecimento funcional do provider de feature flags, autoridade request-scoped, ownership composto, classificador documental e ciclo de vida; harness SPA canônico com proxy same-origin) |
| main_sha        | `main` local contém o candidato `03e6fac0`; a `main` remota está publicada em `origin/main@8bb1bd71`; `origin/fix/state-of-art-ci-assurance@fe5406c2` é ancestral, sem commits funcionais exclusivos; rollback preservado |
...
o manifesto crítico foi reancorado na revisão 69, com a correção de tipografia e rasterização CI/visual, a verificação portátil do runner, o código funcional de feature flags e os
