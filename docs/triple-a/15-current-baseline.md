...
Observado em `2026-09-17T21:09:34Z`, sobre o candidato documental
`5a5388281633a235a6e53909c7432c4535194d70`, que contém a identidade corrente
...
| --------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| current_sha     | `5a5388281633a235a6e53909c7432c4535194d70` (snapshot; registro P0 e manifesto revision 73; importador do evidence graph com validação de schema, SHA, ambiente, frescor, ancestralidade e digest; evidência local permanece `PARTIAL`, sem promoção automática a PASS) |
| main_sha        | `main` remota em `origin/main@a902fc243136` antes deste candidato; publicação deste candidato será sem force-push; `origin/fix/state-of-art-ci-assurance@fe5406c2` permanece ancestral, sem commits funcionais exclusivos |
...
| verified_local  | Typecheck e lint do workspace passaram em `68/68` projetos; module-feature-flags passou `10` testes, os testes focados da API passaram `19/19`, a suíte crítica corrente passou `67/67` arquivos/`618/618` testes de integração e `11/11` cenários de processo, e identidade, P0, importador candidate-bound e complexity de `8.335` linhas foram validados. A evidência SQL `34/34`, k6 local `9/9` e visual `29/29` permanecem evidências anteriores/locais; target externo permanece ausente |
