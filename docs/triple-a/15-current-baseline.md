...
Observado em `2026-09-11T22:45:00Z`. Este snapshot acompanha o commit documental
`3054d6388becd9a262b2cd45fadbabc086c1ed75`; o código funcional avaliado permanece
`68600d6a55dcf18bd04c28ff3ee7528cc686efdb` e a reconciliação é publicada como evidência vinculada a esse candidato.

| Campo | Evidência atual |
| --- | --- |
| current_sha | `3054d6388becd9a262b2cd45fadbabc086c1ed75` — documentação corrente; código funcional avaliado em `68600d6a` |
| code_parent_sha | `55ff8a5250d20f2dbd26c4572095599be485fb69` |
| main_sha | `3054d6388becd9a262b2cd45fadbabc086c1ed75`; contém a documentação corrente e o código funcional `68600d6a` |
...
| ci_run | [#130](https://github.com/ricardoakinaga-dev/cvg-his-v4/actions/runs/34653388064), `failure`, SHA documental, somente Performance falhou; [#129](https://github.com/ricardoakinaga-dev/cvg-his-v4/actions/runs/34650926250) é o CI funcional |
...
benchmark/SLO; as métricas detalhadas exigem credencial. O CI #130, disparado
pela reconciliação documental, repetiu o mesmo padrão: os checks de código
passaram e somente Performance falhou. Nenhuma causa determinística de código
foi comprovada e nenhuma threshold foi alterada. O CI #128 do snapshot anterior
permanece histórico.
