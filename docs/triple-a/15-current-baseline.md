...
Observado em `2026-09-16T02:05:04Z`, no candidato de código
`371e5f844e984b26acb2dc2e1302031ca2a94409`. A identidade canônica está em
...
| --------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| current_sha     | `371e5f844e984b26acb2dc2e1302031ca2a94409` (candidato funcional/controlador atual; históricos permanecem somente comparação) |
| main_sha        | `main@371e5f84`; `origin/main@e4e18fba`; local está 1 commit à frente até publicação; rollback preservado |
...
| ci_run          | `NOT_FOUND` para o SHA exato antes da publicação; o run remoto mais recente observado é [CI #35046394357](https://github.com/ricardoakinaga-dev/cvg-his-v4/actions/runs/35046394357) no candidato anterior `e4e18fba`, que falhou na provisão APT e não é transferido. |
...
| overall_score   | `52` no gate estrito executado com `commitSha=371e5f84`; abaixo do mínimo 97 |
| critical_score  | `51` no gate estrito executado com `commitSha=371e5f84`; abaixo do mínimo 95 |
...
O candidato `371e5f84` foi reconciliado localmente sem force-push; `origin/main`
ainda aponta para `e4e18fba` até a publicação autorizada. O CI anterior não é
