...
| R1 — candidato local | Congelar, identificar e provar o último SHA | NR-004–009 | IN_PROGRESS / EXTERNAL-BLOCKED: runtime `29b03941` passa gates locais; identity/P0 registry/snapshots serão vinculados no freeze limpo; Trivy permanece NOT_RUN |
