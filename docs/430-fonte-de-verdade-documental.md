...
| Tema                                       | Fonte vigente                                                                                                                                                                                |
| ------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Checkpoint de continuidade atual           | `2026-08-24-handoff-laboratory-bootstrap-concurrency.md`                                                                                                                                     |
| Handoffs imediatamente anteriores          | `2026-08-24-handoff-critical-process-suite.md`, `2026-08-24-handoff-cash-receipt-concurrency.md`, `2026-08-24-handoff-cash-receipt-sigkill.md`, `2026-08-24-handoff-worker-account-scope.md` |
