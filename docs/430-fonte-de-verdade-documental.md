...
| Tema                                       | Fonte vigente                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| ------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Checkpoint de continuidade atual           | `2026-08-24-handoff-reports-workbench-payables-export.md` — inclui exportação CSV bounded de Contas a Pagar e Contas Pagas a partir do subledger e limites de paridade funcional                                                                                                                                                                                                                                                                                                                        |
| Handoffs imediatamente anteriores          | `2026-08-24-handoff-reports-workbench-inventory-export.md`, `2026-08-24-handoff-reports-workbench-export.md`, `2026-08-24-handoff-reports-run-once.md`, `2026-08-24-handoff-webhook-storage-audit.md`, `2026-08-24-handoff-pix-runtime-role.md`, `2026-08-24-handoff-laboratory-bootstrap-concurrency.md`, `2026-08-24-handoff-critical-process-suite.md`, `2026-08-24-handoff-cash-receipt-concurrency.md`, `2026-08-24-handoff-cash-receipt-sigkill.md`, `2026-08-24-handoff-worker-account-scope.md` |
