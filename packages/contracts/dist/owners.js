import { z } from 'zod';
import { createPaginatedResponseSchema, idParamSchema, normalizeEmail, normalizePhone, paginationQuerySchema, searchQuerySchema, trim, uuidSchema } from './common.js';
/**
 * ==========================================
 * OWNER SCHEMAS
 * ==========================================
