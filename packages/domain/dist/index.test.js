...
import { AlertSchema, DocumentCreateSchema, DomainValidationError, HandoverDraftSchema, InpatientAdmitSchema, InpatientDischargeSchema, MedicationAdministrationCreateSchema, MedicationOrderCreateSchema, MedicationOrderUpdateSchema, MedicationScheduleCreateSchema, ProtocolContentPublishSchema, ProtocolContentSchema, ProtocolPublishRequestSchema, EncounterCreateSchema, NoteCreateSchema, NoteVersionSchema, OwnerCreateSchema, OwnerUpdateSchema, PatientCreateSchema, PatientUpdateSchema, parseOrThrow422 } from './index.js';
describe('domain contracts', () => {
    ...
    it('gera erro padronizado 422', () => {
        ...
        expect(() => parseOrThrow422(DocumentCreateSchema, {
            filename: '',
            mimeType: 'invalid',
            size: -1
    ...
    it('rejeita publish sem steps e sem escalation.ifWorse', () => {
        ...
        if (!parsed.success) {
            ...
            expect(parsed.error.issues.some((issue) => issue.path.join('.') === 'severityLevels.0.escalation.ifWorse')).toBe(true);
        }
    });
