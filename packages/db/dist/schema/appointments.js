...
export const appointments = pgTable('appointments', {
    ...
    collabStartIdx: index('idx_appointments_collab_start').on(table.accountId, table.primaryCollaboratorId, table.startAt),
    resourceStartIdx: index('idx_appointments_resource_start').on(table.accountId, table.resourceId, table.startAt),
