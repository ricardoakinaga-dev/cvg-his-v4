...
export const clinicalNoteVersions = pgTable('clinical_note_versions', {
    ...
    soapJson: jsonb('soap_json').$type().notNull(),
    reason: text('reason'),
    ...
    noteVersionUnique: uniqueIndex('clinical_note_versions_note_version_unique').on(table.noteId, table.versionNumber)
}));
//# sourceMappingURL=clinical_note_versions.js.map