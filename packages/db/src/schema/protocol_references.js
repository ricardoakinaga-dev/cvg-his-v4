...
export const protocolReferences = pgTable('protocol_references', {
    ...
    refTypeChk: check('protocol_references_ref_type_chk', sql `${table.refType} in ('qdrant_chunk', 'url', 'pdf', 'doi', 'book')`)
}));
//# sourceMappingURL=protocol_references.js.map