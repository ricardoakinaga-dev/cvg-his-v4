...
export const encounterFinancialAccounts = pgTable('encounter_financial_accounts', {
...
export const encounterReceivables = pgTable('encounter_receivables', {
    id: uuid('id').defaultRandom().primaryKey(),
    accountId: uuid('account_id')
        .notNull()
        .references(() => accounts.id, { onDelete: 'cascade' }),
...
export const encounterReceivablePayments = pgTable('encounter_receivable_payments', {
    id: uuid('id').defaultRandom().primaryKey(),
    accountId: uuid('account_id')
        .notNull()
        .references(() => accounts.id, { onDelete: 'cascade' }),
...
//# sourceMappingURL=encounter_financial_accounts.js.map