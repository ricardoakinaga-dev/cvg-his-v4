...
export const imagingModalities = pgTable(
  'imaging_modalities',
  {
...
export const imagingModalityTemplates = pgTable(
  'imaging_modality_templates',
  {
    id: uuid('id').defaultRandom().primaryKey(),
    accountId: uuid('account_id')
      .notNull()
...
export const imagingStudyDocuments = pgTable(
  'imaging_study_documents',
  {
    id: uuid('id').defaultRandom().primaryKey(),
    accountId: uuid('account_id')
      .notNull()
...
export const imagingReportDocuments = pgTable(
...
export const imagingScheduleSlots = pgTable(
...
// Imaging sequences
export const imagingSequences = pgTable(
  'imaging_sequences',
  {
    accountId: uuid('account_id')
      .primaryKey()
