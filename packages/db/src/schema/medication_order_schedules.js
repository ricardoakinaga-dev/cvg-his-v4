...
export const medicationOrderSchedules = pgTable('medication_order_schedules', {
    ...
    timesJson: jsonb('times_json').$type(),
...
//# sourceMappingURL=medication_order_schedules.js.map