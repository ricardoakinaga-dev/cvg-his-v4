...
): PatientContextResponse['navigation'] {
  const nav: PatientContextResponse['navigation'] = {};
...
export function createPatientContextService(db: DbClient) {
  ...
  return {
    ...
    async getPatientContext(
      accountId: string,
      patientId: string
    ): Promise<PatientContextResponse | null> {
    ...
    async getPatientInfo(
      accountId: string,
      patientId: string
    ): Promise<PatientContextInfo | null> {
     ...
     */
    async getStayInfo(accountId: string, stayId: string): Promise<StayContextInfo | null> {
