...
import {
  ...
  shouldTriggerOverdueAlert,
  categorizeDoses,
  DEFAULT_GRACE_MINUTES
} from './doseDueLogic.js';
    ...
    it('should categorize doses correctly', () => {
      const doses = [
        // Overdue: 60 min past
        {
          ...
          delayedUntil: null,
          administrationStatus: undefined as undefined
        },
        // Due: 15 min past
        {
        ...
        // Administered
        {
          scheduledFor: new Date('2026-02-20T08:00:00Z'),
          delayedUntil: null,
          administrationStatus: 'administered' as const
        },
        // Delayed
        {
          scheduledFor: new Date('2026-02-20T08:00:00Z'),
          delayedUntil: new Date('2026-02-20T10:00:00Z'),
          administrationStatus: 'delayed' as const
        }
      ];
