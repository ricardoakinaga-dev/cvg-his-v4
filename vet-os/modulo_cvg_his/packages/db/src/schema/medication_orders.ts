...
export const medicationOrders = pgTable(
  ...
  (table) => ({
    accountStayStatusIdx: index('idx_medication_orders_account_stay_status').on(
      table.accountId,
      table.stayId,
      table.status
    ),
    accountEncounterStatusIdx: index('idx_medication_orders_account_encounter_status').on(
      table.accountId,
      table.encounterId,
      table.status
    ),
