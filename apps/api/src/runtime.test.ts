...
// Fixed weekday slots inside clinic hours (relative "now + N h" drifts out of the agenda).
const REMINDER_SLOTS: Readonly<Record<number, string>> = { 72: '2030-01-07T13:00:00.000Z', 73: '2030-01-07T14:00:00.000Z', 74: '2030-01-07T15:00:00.000Z', 75: '2030-01-07T16:00:00.000Z', 96: '2030-01-08T13:00:00.000Z', 120: '2030-01-09T13:00:00.000Z' };
const futureIso = (slot: number): string => REMINDER_SLOTS[slot]!;
