<template>
  <div class="user-form-page">
    ...
    <div class="user-form__layout">
      ...
      <DsCard title="Guia de cadastro" class="user-form__aside">
        <ul class="user-form__facts">
          <li>Perfis e setores devem refletir o papel real do colaborador.</li>
          <li>Na edição, a senha é opcional e só é alterada se preenchida.</li>
          <li>O login deve ser único e legível para suporte e auditoria.</li>
        </ul>
      </DsCard>
    </div>
  </div>
