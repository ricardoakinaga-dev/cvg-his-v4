<template>
  <div class="laboratory-biochemistry-reference-value-detail-page">
    <AppPageHeader
      :breadcrumbs="['Laboratório', 'Cadastros', 'Vlr. Ref. Bioquímico', referenceValue?.parameter ?? 'Detalhe']"
      title="Detalhes do Valor Bioquímico"
      subtitle="Faixa bioquímica aplicada nos resultados estruturados por painel"
    >
      <template #actions>
        ...
        <DsButton
          ...
          variant="primary"
          tag="a"
          :to="`/laboratory/biochemistry-reference-values/${referenceValue.id}/edit`"
        >
          Editar
        </DsButton>
      </template>
    ...
    <section v-if="referenceValue" class="detail-grid">
      ...
      <DsCard title="Faixa de referência">
        <div class="status-grid">
          ...
          <StatusBadge label="Bioquímico" variant="info" />
        </div>
        <dl class="detail-list">
          <div>
            <dt>Valor Mínimo</dt>
...
<style scoped>
.laboratory-biochemistry-reference-value-detail-page {
  display: flex;
