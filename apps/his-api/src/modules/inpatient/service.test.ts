...
import type { InpatientRepo, InpatientStayRecord } from './repo.js';
import { createInpatientService } from './service.js';

const fakeDb = {} as typeof import('@cvg-his/db').db;

function makeStay(overrides: Partial<InpatientStayRecord> = {}): InpatientStayRecord {
  return {
...
function createRepoMock(): InpatientRepo {
  return {
