...
export const protocolPublishRoutes: FastifyPluginAsync = async (app) => {
  ...
  app.post(
    '/protocol-versions/:versionId/publish',
    {
    ...
    async (request, reply) => {
      ...
      const service = createProtocolPublishService(
        ...
        { enqueueProtocolPublish: queues.enqueueProtocolPublish }
      );
