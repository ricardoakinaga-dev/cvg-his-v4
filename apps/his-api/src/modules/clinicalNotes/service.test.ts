...
import type { ClinicalNoteRecord, ClinicalNotesRepo } from './repo.js';
import { createClinicalNotesService } from './service.js';

const fakeDb = {} as typeof import('@cvg-his/db').db;

function makeNote(overrides: Partial<ClinicalNoteRecord> = {}): ClinicalNoteRecord {
  return {
    id: 'note-1',
...
function createRepoMock(): ClinicalNotesRepo {
  return {
