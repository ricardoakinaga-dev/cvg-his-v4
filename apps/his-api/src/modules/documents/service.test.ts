...
import type { DocumentRecord, DocumentsRepo, EncounterDocumentRecord } from './repo.js';
...
function makeRelation(overrides: Partial<EncounterDocumentRecord> = {}): EncounterDocumentRecord {
  return {
    id: 'relation-1',
...
function createRepoMock(): DocumentsRepo {
  return {
