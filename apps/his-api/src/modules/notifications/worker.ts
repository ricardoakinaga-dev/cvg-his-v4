...
export async function processNotifications(db: DbPool): Promise<{ processed: number; failed: number }> {
...
export async function startNotificationWorker(db: DbPool, intervalMs: number = 60000): Promise<void> {
