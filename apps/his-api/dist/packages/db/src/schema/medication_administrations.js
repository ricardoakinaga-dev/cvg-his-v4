...
export const medicationAdministrations = pgTable('medication_administrations', {
    ...
    orderScheduledIdx: index('idx_medication_administrations_order_scheduled').on(table.orderId, table.scheduledFor),
    accountStayScheduledIdx: index('idx_medication_administrations_account_stay_scheduled').on(table.accountId, table.stayId, table.scheduledFor),
    orderSlotUnique: uniqueIndex('uq_medication_administrations_order_slot').on(table.orderId, table.scheduledFor),
    reasonConsistencyChk: check('medication_administrations_reason_required_chk', sql `(
...
//# sourceMappingURL=medication_administrations.js.map