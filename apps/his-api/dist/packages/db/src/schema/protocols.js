...
export const protocols = pgTable('protocols', {
    ...
    accountDomainSpecialtyIdx: index('idx_protocols_account_domain_specialty').on(table.accountId, table.domain, table.specialty),
    statusChk: check('protocols_status_chk', sql `${table.status} in ('draft', 'published')`)
}));
