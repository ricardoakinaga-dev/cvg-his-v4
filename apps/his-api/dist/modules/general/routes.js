...
import { createOwnerContactsRepo, createOwnerAddressesRepo, createOwnerDocumentsRepo, createOwnerAlertsRepo, createPatientAlertsRepo, createPatientVaccinesRepo, createPatientAllergiesRepo, createTagsRepo, createSearchRepo } from './repo.js';
import { createOwnerContactSchema, createOwnerAddressSchema, createOwnerDocumentSchema, createOwnerAlertSchema, updateOwnerContactSchema, updateOwnerAddressSchema, updateOwnerDocumentSchema, updateOwnerAlertSchema, ownerContactResponseSchema, ownerAddressResponseSchema, ownerDocumentResponseSchema, ownerAlertResponseSchema, createPatientAlertSchema, createPatientVaccineSchema, createPatientAllergySchema, updatePatientVaccineSchema, updatePatientAllergySchema, patientAlertResponseSchema, patientVaccineResponseSchema, patientAllergyResponseSchema, searchQuerySchema, searchResponseSchema, createTagSchema, tagResponseSchema } from './types.js';
...
export const generalRoutes = async (app) => {
    // ============================================
    // SEARCH
    // ============================================
    app.get('/search', {
    ...
    app.patch('/patients/:patientId/vaccines/:id', {
        ...
        if (!updated)
            return reply.status(404).send({ message: 'Vaccine record not found' });
    ...
    app.patch('/patients/:patientId/allergies/:id', {
        ...
        if (!updated)
            return reply.status(404).send({ message: 'Allergy record not found' });
