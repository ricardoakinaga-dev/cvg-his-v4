...
import { createSettingsService, ALLOWED_NAMESPACES } from './service.js';
// Validation schemas
...
const valueJsonSchema = z.any().refine((val) => {
    try {
...
export const settingsRoutes = async (app) => {
    ...
    app.get('/:namespace', async (request, reply) => {
    ...
    app.put('/:namespace/:key', async (request, reply) => {
