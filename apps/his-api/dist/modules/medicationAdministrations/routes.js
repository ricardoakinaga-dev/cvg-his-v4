...
const medicationAdministrationWithConfirmationSchema = z.intersection(MedicationAdministrationCreateSchema, z.object({
    patientConfirmation: patientConfirmationSchema.optional()
}));
export const medicationAdministrationsRoutes = async (app) => {
    app.post('/', {
        ...
        const body = parseOrThrow422(medicationAdministrationWithConfirmationSchema, payload);
