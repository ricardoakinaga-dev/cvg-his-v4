import { ProtocolCreateSchema, ProtocolUpdateSchema, parseOrThrow422 } from '@cvg-his/domain';
import { z } from 'zod';
import { requirePermission } from '../../middlewares/requirePermission.js';
import { createProtocolsService } from './service.js';
import { listProtocolsQuerySchema, protocolIdParamSchema } from './types.js';
const listProtocolAuditQuerySchema = z.object({
    page: z.coerce.number().int().positive().default(1),
    pageSize: z.coerce.number().int().positive().max(100).default(20)
});
export const protocolsRoutes = async (app) => {
    app.post('/', {
