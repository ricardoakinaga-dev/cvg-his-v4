...
import { listUsersQuerySchema, createUserSchema, updateUserSchema, disableUserSchema, listRolesQuerySchema, createRoleSchema, updateRoleSchema, updateRolePermissionsSchema, updateUserRolesSchema, listAuditQuerySchema } from './types.js';
import { findUsers, findUserById, createUser, updateUser, setUserActiveStatus, replaceUserRoles, findRoles, findRoleById, createRole, updateRole, deleteRole, replaceRolePermissions, isRoleInUse, findAllPermissions, findAuditEvents } from './repo.js';
...
export const adminRoutes = async (app) => {
    ...
    app.put('/admin/roles/:id/permissions', {
