...
export const protocolVersionsRoutes = async (app) => {
    app.post('/protocols/:id/versions', {
    ...
    app.get('/protocol-versions/:versionId', {
        preHandler: requirePermission('protocol.read')
    }, async (request, reply) => {
    ...
    app.patch('/protocol-versions/:versionId', {
        preHandler: requirePermission('protocol.write')
    }, async (request, reply) => {
        const params = versionIdParamSchema.parse(request.params);
