import { MedicationScheduleCreateSchemaBase, // <--- Importando a Base
MedicationScheduleUpdateSchema, parseOrThrow422 } from '@cvg-his/domain';
import { z } from 'zod';
...
export const medicationSchedulesRoutes = async (app) => {
