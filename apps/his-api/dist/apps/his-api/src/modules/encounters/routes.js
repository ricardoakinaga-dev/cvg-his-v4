import { createEncounterBodySchema, closeEncounterBodySchema, encounterIdParamSchema, listEncountersQuerySchema, encounterResponseSchema, listEncountersResponseSchema, encounterTimelineResponseSchema } from '@cvg-his/contracts';
import { requirePermission } from '../../middlewares/requirePermission.js';
import { createEncountersService } from './service.js';
export const encountersRoutes = async (app) => {
    app.post('/', {
