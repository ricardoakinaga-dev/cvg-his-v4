import { MedicationOrderCreateSchema, MedicationOrderStopSchema, MedicationOrderUpdateSchema, parseOrThrow422 } from '@cvg-his/domain';
import { requirePermission } from '../../middlewares/requirePermission.js';
import { createMedicationOrdersService } from './service.js';
import { listMedicationOrdersQuerySchema, medicationOrderIdParamSchema } from './types.js';
export const medicationOrdersRoutes = async (app) => {
    app.post('/', {
