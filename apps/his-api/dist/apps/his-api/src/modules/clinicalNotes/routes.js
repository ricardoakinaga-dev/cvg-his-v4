import { NoteCreateSchema, NoteSignSchema, NoteUpdateSchema, NoteVersionSchema, parseOrThrow422 } from '@cvg-his/domain';
import { z } from 'zod';
...
export const clinicalNotesRoutes = async (app) => {
    app.post('/encounters/:id/notes', {
