...
import { createClinicalNoteSignedEvent, createClinicalNoteVersionCreatedEvent } from '@cvg-his/events';
import { createClinicalNotesRepo } from './repo.js';
...
export function createClinicalNotesService(context, dependencies = {}) {
    const repo = dependencies.repo ?? createClinicalNotesRepo(context.db);
    const appendAudit = dependencies.appendAudit ?? append;
    async function createVersionMutation(actor, noteId, input, action) {
