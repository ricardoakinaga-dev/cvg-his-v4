...
- Next action: write the real socket HTTP callback RED, then implement service-principal/login exclusions and the shared fenced worker UoW; SPA remains separately gated `B2c` work.
