...
- Fresh bounded evidence is API-key service 13/13, mapper 3/3, auth helper 2/2, runtime ACL/RLS 1/1, shared-database/API builds and lint, RLS 153/154, OpenAPI 335/386, Helm static validation, secret scan and diff check. Implementation `62db87e` and documentation checkpoint `8d226d0` are pushed; the design-system tsbuildinfo cache remains unstaged.
